...
# from precallagent.prompt_utils import get_calculated_dates
# # from .tools.scenario_profile import format_scenario_profile_for_prompt
# from precallagent.scenario_classsifier import classify_scenario
...
class CollectionsCallGraph:
    ...
    def _parse_data(self, language: Optional[str]):
        ...
        # self.scenario_behavior = classify_scenario
    # ──────────────────────────────────────────────────────────────────
    # GRAPH CONSTRUCTION
    # ──────────────────────────────────────────────────────────────────
